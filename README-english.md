...
[**Code Specialist 7B**](https://huggingface.co/Ricardouchub/code-specialist-7b) is a LLM fine-tuned on **Mistral-7B-Instruct-v0.3** with a focus on code generation and explanation in **Python** and **SQL**, aimed at data science and analytics tasks.  
